...
public class ElevenLabs : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        npc_Animator = gameObject.GetComponent<Animator>();
    }


    public ElevenLabs(string apiKey, string voiceId)
    {
        _apiKey = apiKey;
        _voiceId = voiceId;
    }
    ...
    IEnumerator DoRequest(string message)
    {
        ...
        if (audioClip != null)
        {
            Debug.Log("Received audio clip");
            audioSource.PlayOneShot(audioClip);
            npc_Animator.SetTrigger("Talk");
    ...
    public void TestTTS()
    {
        string testText = "Hello, this is a test of the Eleven Labs Text to Speech API.";
        GetAudio(testText);
        Debug.Log("TestTTS Ran");
    }
