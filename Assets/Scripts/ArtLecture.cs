...
public class ArtLecture : MonoBehaviour
{
    ...
    {
        string instruction = "You're an art history teacher. Give me a 20 second summary of the significance about this art period.";
